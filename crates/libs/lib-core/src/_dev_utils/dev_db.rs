...
const PG_DEV_POSTGRES_URL: &str = "mysql://root:admin@localhost:3306/inventario_guitarras";
const PG_DEV_APP_URL: &str = "mysql://app_user:dev_only_pwd@localhost:3306/inventario_guitarras";
